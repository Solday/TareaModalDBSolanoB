...
function InsertarRegistro() {
    ...
    if (cedula == null || cedula.toString().length !== 14) { // se tiene que reemplazar por la validacion de la cedula
        ...
        e.innerHTML = genero;
        if (genero === 'Masculino') {
            img.innerHTML = `<img src="./assets/img/man.png" id="imgT" class="imgTable" alt="" >`;
        } else {
            img.innerHTML = `<img src="./assets/img/mujer.png" id="imgT" class="imgTable" alt="" >`;
        }
        ...
        <img src="./assets/img/editar.png" id="imgT" class="imgAction" alt="" >
    </button>`;
        buttons = buttons.concat("&nbsp;").concat(`<button type="button" class="btnLite" name="DeleteButton" onclick='deleteRow(this)'>
        <img src="./assets/img/borrar.png" id="imgT" class="imgAction" alt="" >
    </button>`);
        g.innerHTML = buttons;
...
function ActualizarRegistro() {
    ...
    if (selectedRowIndex !== -1) {
        ...
        let genero = getCheckedRadioValue('Sexo');
        if (genero === 'Masculino') {
            table.rows[selectedRowIndex].cells[0].innerHTML = `<img src="./assets/img/man.png" id="imgT" class="imgTable" alt="" >`;
        } else {
            table.rows[selectedRowIndex].cells[0].innerHTML = `<img src="./assets/img/mujer.png" id="imgT" class="imgTable" alt="" >`;
        }
